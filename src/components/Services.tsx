...
const services = [
	...
	},
	{
		...
		href: "/ia-para-negocios",
	},
];

export const Services = () => {
	return (
		<section id="services" className="pt-[70px] md:pt-16 pb-[70px] md:pb-16">
					...
					{services.map((service, index) => (
						...
						>
							...
							<CardContent className="space-y-4">
								...
								>
									<Link to={service.href} style={{ textTransform: "none" }}>
										{service.cta.charAt(0).toUpperCase() +
											service.cta.slice(1).toLowerCase()}
